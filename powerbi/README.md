...
- **18 Measures** (in `dim_abschluss.tmdl`, inkl. `Schüleranteil ohne Grundschule %` für die LF5-Fokussicht), je gegen Referenzwert (`data/kpi_referenzwerte.json`) geprüft; darunter der 3-dimensionale Risiko-Score (LF9, inkl. Einkommen), StdAbw Quote ohne HSA (Kreise) (LF3) und Verf. Einkommen je EW Ø.
