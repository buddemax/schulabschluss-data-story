...
- **Gesamt-Prüfsuite** (automatische binäre Akzeptanztests) – (KPIs gg. Referenzwerte inkl. LF9-Risiko-Score und LF3-Streuung, Datenintegrität, .pbix/TMDL inkl. 18 Measures, Region-Hierarchie Land→Regierungsbezirk→Kreis, LF9-3-dim-Risiko-Score inkl. Einkommen, LF8-Stadtstaat-Farbtrennung + Okabe-Ito-Report-Theme, DWH-Deliverables (Bus-Matrix/Additivität/SCD/OLAP-Einordnung), DOCX/PPTX/Charts, Doku↔Artefakt-Konsistenz, Interaktivität/Karten/Slicer, Traceability). Aktueller Stand: **alle grün** (Exit 0).
...
- [x] **`powerbi/SchulabschlussDataStory.pbix`** exportiert (Seiten LF1–LF9 inkl. 2 Karten + 15 Slicer/Slider) – zusätzlich liegt der PBIP-Ordner bei
