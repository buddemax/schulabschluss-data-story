...
> **Validierungsregel (§7d):** Eine Measure gilt als bestätigt, wenn das Power-BI-Ergebnis mit der Nachrechnung übereinstimmt. Wir haben das auf zwei Wegen geprüft: jede Kennzahl unabhängig aus den Rohdaten nachgerechnet und die 18 DAX-Measures im TMDL gegengelesen; Stichproben (LF1 Sachsen-Anhalt 12,66 %, LF2 16,78 %, LF5 35,23 %, LF9 3-dim Risiko-Score Gelsenkirchen 8,09, LF3 RLP σ 2,84) zusätzlich live in Power BI Desktop abgeglichen. Bezugsjahr der abgängebasierten Visuals ist 2023 (Bericht-Filter `dim_zeit[jahr]=2023`, DQ11).
...
**KPI:** z-standardisierter Score aus `Quote ohne HSA %` (2023) + `Jugend-ALQ 15-25` (2025) + verfügbarem Einkommen je Einwohner (VGRdL, 2021, invertiert: niedriges Einkommen = hohes Risiko). Damit deckt LF9 alle drei in der Leitfrage genannten Dimensionen ab.
```DAX
Risiko-Score =
 VAR pop =
 CALCULATETABLE (
...
**Referenzwert (Top-8, 3-dimensional):** Gelsenkirchen 8,09 · Pirmasens 7,41 · Mansfeld-Südharz 6,56 · Stendal 6,03 · Bremerhaven 6,01 · Uckermark 5,99 · Halle (Saale) 5,90 · Gera 5,84. Mit Einkommen rückt Gelsenkirchen (verfügbares Einkommen nur ~17.900 EUR je EW) an die Spitze; Bremerhaven kommt neu in die Top-5.
**Datengrundlage und Plausibilität:** Einkommen = verfügbares Einkommen der privaten Haushalte je Einwohner (Regionalstatistik 82411-01-03-4, VGRdL, Stand 2021, Kreisebene). Niedriges Einkommen korreliert erwartungsgemäß mit hohem Bildungsrisiko (r=-0,49) und hoher Jugendarbeitslosigkeit (r=-0,59) – die drei Dimensionen zeigen also in dieselbe Richtung. Datenstände: ohne HSA 2023, Jugend-ALQ 2025, Einkommen 2021; der Score ist als Strukturindikator zu lesen, nicht als Momentaufnahme.
**Sensitivität (nachgerechnet):** Über sieben geprüfte Gewichtungen (gleich (1,1,1); bildungslastig (3,1,1),(2,1,1); ALQ-lastig (1,3,1),(1,2,1); einkommenslastig (1,1,3),(1,1,2)) bleibt das **Führungsduo Gelsenkirchen und Pirmasens durchgängig in den Top-3** und stellt in jeder Variante den Erstplatzierten (beide wechseln sich ab). Die weiteren Ränge variieren gewichtungsabhängig (z. B. Mansfeld-Südharz bei gleicher Gewichtung Rang 3, fällt bei einkommens- oder ALQ-lastiger Gewichtung aus den Top-5; Bremerhaven bzw. Uckermark rücken dann auf). Die Kernaussage – dieselben strukturschwachen Kreise führen – ist damit robust, die exakte Reihenfolge dahinter nicht. Der zweidimensionale Kern-Zusammenhang Bildungsrisiko ↔ Jugendarbeitslosigkeit ist über alle 398 Kreise hochsignifikant (r=+0,58, p<0,001, 95%-KI nach Fisher-z [+0,51; +0,64]) und – anders als bei LF8 mit nur 16 Ländern – durch die große Kreiszahl eng geschätzt.
...
|LF9|Risiko-Score (3-dim)|ja|ja|live (3-dim Score inkl. Einkommen, Gelsenkirchen 8,09; Kern-r ohne-HSA↔ALQ =+0,58, p<0,001, n=398)|
