...
| 9 | LF9 | **Dot-/Strip-Plot** (Risiko-Score je Bundesland, ein Punkt je Kreis) + Risiko-Tabelle + Methodik-Box | X `[BL-Position]` (01–16), Y `[Risiko-Score]` (3-dim, z-standardisiert), Punkt = Kreis, Top-10 akzentuiert | `ebene=KR` | „Risiko-Kreise verbinden Bildung, Arbeitslosigkeit & Einkommen – Gelsenkirchen führt (8,08), West wie Ost" | `charts/LF9_risiko_scatter.png` + PBI-Seite LF9 |
